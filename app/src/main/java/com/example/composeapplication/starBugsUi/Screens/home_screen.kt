...
import com.example.composeapplication.starBugsUi.menu
import com.example.composeapplication.starBugsUi.menuList
import com.example.composeapplication.starBugsUi.navigation.detail
import com.example.composeapplication.ui.theme.Background
import com.example.composeapplication.ui.theme.DarkGray_1
import com.example.composeapplication.ui.theme.DarkGreen
import com.example.composeapplication.ui.theme.Gray_1
...
private fun SearchBarScreen(
    ...
    TextField(
        ...
        leadingIcon = {
            IconComponent(icon = R.drawable.ic_search)
        },
        modifier = modifier.fillMaxWidth(),
...
private fun Header() {
    Row(
        ...
        AppIconComponent(icon = R.drawable.ic_bag)
    }
